      ...
      <Card sx={{ width: "100%", mb: 3 }}>
        <CardContent>
          ...
          <Box display="flex" justifyContent="space-between" mb={2}>
            <Typography color="textSecondary">{t('student_id')}</Typography>
          ...
          {/* Age */}
          <Box display="flex" justifyContent="space-between" mb={2}>
            <Typography color="textSecondary">{t('age')}</Typography>
          ...
          <Box display="flex" justifyContent="space-between" mb={2}>
            ...
            <Typography fontWeight="bold">{profile.Gender ? t('male') : t('female')}</Typography>
          </Box>
        </CardContent>
      </Card>
